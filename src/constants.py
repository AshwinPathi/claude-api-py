...
ORGANIZATIONS_API_ENDPOINT = '/api/organizations'
...
CHAT_CONVERSATIONS_API_ENDPOINT = ORGANIZATIONS_API_ENDPOINT + '/{organization_uuid}/chat_conversations'

# API endpoint for generating a chat title.
CHAT_TITLE_API_ENDPOINT = '/api/generate_chat_title'
